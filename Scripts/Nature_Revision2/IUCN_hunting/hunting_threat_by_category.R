# ----------------------------------------------------------------------------
# Nature Revision 2 — IUCN hunting threat overlay for bird species groups
#
# I match Borneo bird species to IUCN threat matrix scores so I can flag medium/high hunting pressure alongside my occupancy categories.
# Inputs: inputs/sppCategoriesSept24.rds; inputs/AllBorneoSpeciesTraits.csv; inputs/IUCN_wide_ThreatMatrix_Sept2024.csv (paths relative to this IUCN_hunting folder).
# Outputs: an augmented table in-memory (print/check blocks); I save RDS when I uncomment the final write section at the bottom.
# ----------------------------------------------------------------------------
