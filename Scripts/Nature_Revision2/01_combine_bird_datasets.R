...
# =============================================================================
# What I'm doing: I'm building one tidy point-count dataset for Borneo birds by merging Cerullo/Kong 2022
#   plantations, David Edwards historic forest PCs, Simon Mitchell logged/OG data, and LiDAR covariates
#   (GEE buffers). I optionally leave AVONET trait extraction commented out.
#
# What I need (inputs): CSVs under `RawData/` (e.g. plantation PCs, forest PCs, Simon data, 2022 forest
#   site CSVs), `Inputs/SimonDaveSpeciesNamesCrossWalk.csv`, LiDAR CSVs, and related lookups.
#
# What I produce (outputs): I write `Outputs/NR2/rds/allDanielDaveSimonDetectionsWithLidar.csv` and
#   `Outputs/NR2/rds/birdDataForFlockr.csv` for the next script.
# =============================================================================
...
write.csv(all_PCs2009_2022, file.path(nr2_rds_dir, "allDanielDaveSimonDetectionsWithLidar.csv"))

#explort dataframe ready for flockr, in next script
write.csv(full_birds_flockr, file.path(nr2_rds_dir, "birdDataForFlockr.csv"))

plantation_age<- read.csv(file.path(nr2_rds_dir, "birdDataForFlockr.csv")) %>%  
...
zenodo <- read.csv(file.path(nr2_rds_dir, "allDanielDaveSimonDetectionsWithLidar.csv")) %>%  
