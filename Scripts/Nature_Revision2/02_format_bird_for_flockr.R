...
# =============================================================================
# What I'm doing: I'm reshaping my combined point-count table into flocker inputs (wide detections,
#   scaled visit times, covariates) and I save flocker data objects for `flock()` in the next step.
#
# What I need (inputs): `Outputs/NR2/rds/birdDataForFlockr.csv` from my combine script.
#
# What I produce (outputs): `Outputs/NR2/models/fd_28-05-24.rds` (main) and
#   `Outputs/NR2/models/fd_no_visit_cov_28-05-24.rds` (ZI / no-visit-cov variant).
# =============================================================================
...
df_birds <- read.csv(file.path(nr2_paths$rds_dir, "birdDataForFlockr.csv")) # the output of the Combine_Bird_Datasets script
names(df_birds)
...
saveRDS(fd, file.path(nr2_paths$models_dir, "fd_28-05-24.rds"))
...
saveRDS(fd_zi, file.path(nr2_paths$models_dir, "fd_no_visit_cov_28-05-24.rds"))
