# =============================================================================
# Self-notes — scenario assessment (legacy `Outputs/` layout)
# =============================================================================
# What I'm doing: Same logic as my NR2 `04_assess_scenario_outcomes.R`—landscape propagation, relative
#   occupancy, categories—but I target `Outputs/` paths and older filenames (e.g. dated RDS).
#
# What I need (inputs): `Inputs/ScenarioParams.R`, predicted draws, scenario CSVs, processed birds RDS.
#
# What I produce (outputs): Processed birds, SL/scenario occ, rel occ, best-scenario RDS, consolidated
#   summary RDS under `Outputs/` (see script body).
# =============================================================================
