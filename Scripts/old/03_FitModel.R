# =============================================================================
# Self-notes — bird occupancy model (legacy paths)
# =============================================================================
# What I'm doing: I'm fitting my flocker/brms occupancy model; file paths point at my Dropbox/cmdstan
#   layout from when I ran this outside NR2.
#
# What I need (inputs): `Outputs/fd_28-05-24.rds`.
#
# What I produce (outputs): `fit.rds` / `fit_backup.rds` under the Dropbox paths set in this file (I should
#   align with `Outputs/NR2/models/` if I migrate fully to NR2).
# =============================================================================
