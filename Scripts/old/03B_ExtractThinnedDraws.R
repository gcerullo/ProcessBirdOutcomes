# =============================================================================
# Self-notes — predicted occupancy draws (legacy `outputs/` + `figures/`)
# =============================================================================
# What I'm doing: Same thinning/prediction as NR2 `03B`, but I read/write under `outputs/` and `figures/`.
#
# What I need (inputs): `outputs/fit_2024-07-12.rds`, `outputs/fd_2024-07-12.rds`.
#
# What I produce (outputs): `outputs/predicted_occupancy_500_draws*.rds`, diagnostic PNGs in `figures/`.
# =============================================================================
